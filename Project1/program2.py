#This program asks the user for an element name, how many moles they have, and the mass of the element,
#then calculates the total mass and how many there are
